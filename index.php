...
if (is_post_request()) {
    if (isset($_POST['email']) && !empty($_POST['email'])) {
        ...
        $em_validate = $account->validateEmail($email);

        if (is_int($em_validate)) {
        } else {
            session_regenerate_id();
            $_SESSION['email'] = $em_validate;
            redirect_to(url_for('signup'));
        }
    }
}
...
<section class="banner">
    <img src="frontend/assets/images/banner.jpg" alt="banner" class="out-story-card-background">
    <div class="out-story-card-text">
        <div class="heading">
